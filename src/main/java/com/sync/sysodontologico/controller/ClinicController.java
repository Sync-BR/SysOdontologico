...
public class ClinicController {
    ...
    public String register(ClinicDto newClinic, RedirectAttributes redirectAttributes) {
        if(clinicService.register(newClinic)){
            redirectAttributes.addFlashAttribute("messageSucess", "Clinic criado com sucesso!");
            return "redirect:/user/home";
        } else {
            redirectAttributes.addFlashAttribute("message", "Clinic criado com sucesso!");
        }
